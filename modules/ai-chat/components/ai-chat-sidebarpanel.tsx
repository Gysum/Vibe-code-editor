            ...
            <div className="flex items-end gap-3">
              <div className="flex-1 relative">
                <Textarea
                  ...
                  disabled={isLoading}
                  className="<min-h-11></min-h-11> max-h-32 bg-zinc-800/50 border-zinc-700/50 text-zinc-100 placeholder-zinc-500 focus:border-blue-500 focus:ring-blue-500/20 resize-none pr-20"
                  rows={1}
                />
